...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/blank-map.csv", __ASSET__assets_data_blank_map_csv);
		type.set ("assets/data/blank-map.csv", AssetType.TEXT);
		className.set ("assets/data/data-goes-here.txt", __ASSET__assets_data_data_goes_here_txt);
		type.set ("assets/data/data-goes-here.txt", AssetType.TEXT);
		className.set ("assets/images/images-go-here.txt", __ASSET__assets_images_images_go_here_txt);
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		className.set ("assets/images/imp_color.png", __ASSET__assets_images_imp_color_png);
		type.set ("assets/images/imp_color.png", AssetType.IMAGE);
		className.set ("assets/images/imp_grey.png", __ASSET__assets_images_imp_grey_png);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/imp_color.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/imp_grey.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_blank_map_csv extends flash.utils.ByteArray { }
...
@:file("assets/data/blank-map.csv") #if display private #end class __ASSET__assets_data_blank_map_csv extends lime.utils.Bytes {}
...
@:file("C:/HaxeToolkit/haxe/lib/flixel/git/assets/sounds/flixel.mp3") #if display private #end class __ASSET__assets_sounds_flixel_mp3 extends lime.utils.Bytes {}
