...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "GGJ2016", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "GGJ2016";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "GGJ2016", null, { width: 1280, height: 720 });
...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/ui/button.png");
