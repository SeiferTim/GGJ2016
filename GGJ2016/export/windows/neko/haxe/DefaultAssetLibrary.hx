...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__assets_fonts_monsterrat_ttf);
...
@:font("C:/HaxeToolkit/haxe/lib/flixel/git/assets/fonts/monsterrat.ttf") @:keep #if display private #end class __ASSET__assets_fonts_monsterrat_ttf extends flash.text.Font {}
@:bitmap("C:/HaxeToolkit/haxe/lib/flixel/git/assets/images/ui/button.png") @:keep #if display private #end class __ASSET__assets_images_ui_button_png extends flash.display.BitmapData {}
...
class __ASSET__assets_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/monsterrat.ttf"; fontName = "Monsterrat";  }}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/data/blank-map.csv", "assets/data/blank-map.csv");
		type.set ("assets/data/blank-map.csv", AssetType.TEXT);
		path.set ("assets/data/data-goes-here.txt", "assets/data/data-goes-here.txt");
		type.set ("assets/data/data-goes-here.txt", AssetType.TEXT);
		path.set ("assets/images/images-go-here.txt", "assets/images/images-go-here.txt");
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		path.set ("assets/images/test_tile.png", "assets/images/test_tile.png");
...
@:keep @:bind #if display private #end class __ASSET__assets_fonts_monsterrat_ttf extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_images_ui_button_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:font("C:/HaxeToolkit/haxe/lib/flixel/git/assets/fonts/monsterrat.ttf") #if display private #end class __ASSET__assets_fonts_monsterrat_ttf extends lime.text.Font {}
@:image("C:/HaxeToolkit/haxe/lib/flixel/git/assets/images/ui/button.png") #if display private #end class __ASSET__assets_images_ui_button_png extends lime.graphics.Image {}
